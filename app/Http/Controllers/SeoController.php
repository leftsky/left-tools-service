...
class SeoController extends Controller
{
    ...
    public function getPageSeo(Request $request): JsonResponse
    {
        ...
        switch ($path) {
            ...
            case '/':
                $seoData = [
                    'title' => '格式转换大王 - 专业在线工具服务平台 | 视频格式转换、抖音文案提取、音频处理',
            ...
            case 'video-converter':
                $seoData = [
                    'title' => '视频格式转换工具 - 在线MP4、AVI、MOV、MKV转换器 | 格式转换大王',
            ...
            case 'tools':
                $seoData = [
                    'title' => '在线工具集合 - 视频转换、文案提取、音频处理 | 格式转换大王',
            ...
            case 'about':
                $seoData = [
                    'title' => '关于我们 - 格式转换大王 | 专业在线工具服务平台',
                    'description' => '格式转换大王致力于为用户提供高质量、高效率的在线工具服务，包括视频格式转换、抖音文案提取、音频处理等，让技术更好地服务于生活。',
                    'keywords' => '关于我们,格式转换大王,在线工具,视频转换,文案提取,音频处理',
                    'og_title' => '关于我们 - 格式转换大王',
